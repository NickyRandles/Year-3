...
public class wealthBuilder extends JxFrame 
  implements ListSelectionListener, ActionListener {
    ...
    private void buildStockLists() {
        ...
        JapaneseStock.addElement("Apple");
        JapaneseStock.addElement("Microsoft");
        JapaneseStock.addElement("Toshiba");
        JapaneseStock.addElement("Lenovo");
        JapaneseStock.addElement("HP");
