...
<div id="mainBody">
	<header>
		...
		<nav>
			<ul>
				<li  id = "currentPage"><a href = "index.html">Home</a>
				</li>
				<li><a href = "aboutRatoath.html">About</a>
				<ul>
					<li><a href = "aboutRatoath.html">About Ratoath</a></li>
					<li><a href = "aboutCentre.html">About Centre</a></li>
				</ul>
				</li>
				<li><a href = "activities.html">Activities</a></li>
				<li><a href = "venue.html">The Venue Theatre</a></li>
				<li><a href = "gallery.html">Gallery</a></li>
				<li><a href = "location.html">More</a>
				<ul>
	...
	<div id = "leftSide">
	<h1>Welcome to the <br> Ratoath Community Centre <br> website!</h1>
		<div id = "info">
			<div id = "switcher">
				<span id = "size">Font Size</span>
			...
			<div class = "speech">
				<p>
				St Olivers Community Centre Ltd (SOCCL) operates a multi-purpose modern community centre in Ratoath, including a 234 seat theatre, a community creche, a restaurant and 5 large multi-purpose rooms together with a 7 acre community sports campus hosting tennis, rugby, athletics and other sports.
				</p>
				<p>
	...
	<div id = "rightSide">
		<div id = "photoShow">
			<div class = "current">
				<img src = "images/image01.jpg" alt = "Photo Gallery" height = "400" width  = "455" class = "photoGallery">
			</div>
			<div>
				<img src = "images/image02.jpg" alt = "Photo Gallery" height = "400" width  = "455" class = "photoGallery">
			</div>
			<div>
				<img src = "images/image03.jpg" alt = "Photo Gallery" height = "400" width  = "455" class = "photoGallery">
			</div>
			<div>
				<img src = "images/image04.jpg" alt = "Photo Gallery" height = "400" width  = "455" class = "photoGallery">
			</div>
		</div>
		<table border = "1" id = "table">
			<caption>Opening hours</caption>
			<tr>
				<th>Day</th> <th>Opening time </th><th>Closing time</th>
			</tr>
			<tr>
				<td>Monday</td> <td>9 a.m</td> <td>8 p.m</td>
			</tr>
			<tr>
				<td>Tuesday</td> <td>9 a.m</td> <td>8 p.m</td>
			</tr>
			<tr>
				<td>Wednesday</td> <td>9 a.m</td> <td>8 p.m</td>
			</tr>
			<tr>
				<td>Thusday</td> <td>9 a.m</td> <td>8 p.m</td>
			</tr>
			<tr>
				<td>Friday</td> <td>9 a.m</td> <td>10 p.m</td>
			</tr>
			<tr>
				<td>Saturday</td> <td>10 a.m</td> <td>12 p.m</td>
			</tr>
			<tr>
				<td>Sunday</td> <td>10 a.m</td> <td>12 p.m</td>
			</tr>
		</table>
	</div>
</div>
<footer>
	<hr>
	<p>
	Telephone no:  01 6895600
	</p>
	<p>
	Fax no: 01 6895601
	</p>
	<p>
	Email: <a href = "mailto:info@ratoathcc.ie"><img src = "images/email.png" height = "25" width = "50" alt = "Email image" id = "email"></a>
	</p>
</footer>
</body>
</html>